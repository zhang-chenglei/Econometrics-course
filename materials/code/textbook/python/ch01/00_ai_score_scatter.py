...
生成正文图1-1（散点图）、图1-2（加入拟合线）、图1-4（总体回归线与样本回归线）。
...
df.to_csv(HERE / "ch01_ai_score_sample.csv", index=False, encoding="utf-8-sig")
...
fig.tight_layout()
fig.savefig(IMAGE_DIR / "ch01-fig1-ai-score-scatter.png", dpi=220, bbox_inches="tight")
...
fig.tight_layout()
fig.savefig(IMAGE_DIR / "ch01-fig2-ai-score-fit.png", dpi=220, bbox_inches="tight")
...
ax.legend(frameon=False)
fig.tight_layout()
fig.savefig(IMAGE_DIR / "ch01-fig4-population-vs-sample.png", dpi=220, bbox_inches="tight")
